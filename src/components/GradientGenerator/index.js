    ...
    return (
      ...
      >
        <ResponsiveContainer>
          ...
          <GradientDirectionList>
            {gradientDirectionsList.map(eachListValue => (
              <GradientDirectionItem
                key={eachListValue.directionId}
                gradientDirectionDetails={eachListValue}
                isActive={activeGradientDirection === eachListValue.value}
